#ifndef _GD32E230X_H_
#define _GD32E230X_H_
...
#define __VTOR_PRESENT            1 /*!< Vector Table Offset Register present          */
...
typedef struct {
    __IO uint32_t STAT;         /*!< ADC status register, offset:0x00 */
    __IO uint32_t CTL0;         /*!< ADC control register, offset:0x04 */
    __IO uint32_t CTL1;         /*!< ADC control register, offset:0x08 */
    __IO uint32_t SAMPT0;       /*!< ADC sample time register 1, offset:0x0C */
    __IO uint32_t SAMPT1;       /*!< ADC sample time register 2, offset:0x10 */
    __IO uint32_t IOFF[4];      /*!< ADC Sampling time register, offset:0x14 - 0x20 */
    __IO uint32_t WDHT;         /*!< Watchdog high, offset: 0x24 */
    __IO uint32_t WDLT;         /*!< Watchdog low, offset: 0x28 */
    __IO uint32_t RSQ0;         /*!< Regular sequence register 0, offset:0x2C */
    __IO uint32_t RSQ1;         /*!< Regular sequence register 1, offset:0x30 */
    __IO uint32_t RSQ2;         /*!< Regular sequence register 2, offset:0x34 */
    __IO uint32_t ISQ;          /*!< Inserted sequence register, offcet:0x38 */
    __IO uint32_t IDATA[4];     /*!< Inserted data register, offset:0x3C - 0x48 */
    __IO uint32_t RDATA;        /*!< Regular data register, offset:0x4C */
    __IO uint32_t RESERVED[12]; /*!< Reserved, offset:0x50 - 0x7C */
    __IO uint32_t OVSAMPCTL;    /*!< Oversampling control register, offset:0x80 */
} ADC_TypeDef;
...
typedef struct {
    __IO uint32_t CTL0;         /*!< ADC status register, offset:0x00 */
    __IO uint32_t CTL1;         /*!< ADC control register, offset:0x04 */
    __IO uint32_t SADDR0;         /*!< ADC control register, offset:0x08 */
    __IO uint32_t SADDR1;       /*!< ADC sample time register 1, offset:0x0C */
    __IO uint32_t DATA;       /*!< ADC sample time register 2, offset:0x10 */
    __IO uint32_t STAT0;      /*!< ADC Sampling time register, offset:0x14 */
    __IO uint32_t STAT1;         /*!< Watchdog high, offset: 0x18 */
    __IO uint32_t CKCFG;         /*!< Watchdog low, offset: 0x1C */
    __IO uint32_t RT;            /*!< Watchdog low, offset: 0x20 */
    __IO uint32_t RESERVED0[22]; /*!< Reserved, offset:0x50 - 0x7C */
    __IO uint32_t SAMCS;    /*!< Oversampling control register, offset:0x80 */
    __IO uint32_t RESERVED1[3]; /*!< Reserved, offset:0x50 - 0x7C */
    __IO uint32_t FMPCFG;    /*!< Oversampling control register, offset:0x80 */
} I2C_TypeDef;
...
/*                                                                            */
/******************************************************************************/
/********************  Bits definition for ADC_STAT register  ******************/
#define ADC_STAT_STRC                         ((uint32_t)0x00000010)        /*!< Start flag of regular group */
#define ADC_STAT_STIC                         ((uint32_t)0x00000008)        /*!< Start flag of inserted group */
#define ADC_STAT_EOIC                         ((uint32_t)0x00000004)        /*!< End of inserted group conversion */
#define ADC_STAT_EOC                          ((uint32_t)0x00000002)        /*!< End of regular group conversion */
#define ADC_STAT_WDE                          ((uint32_t)0x00000001)        /*!< Analog watchdog event flag */

/********************  Bits definition for ADC_CTL0 register  ******************/
#define ADC_CTL0_DRES                         ((uint32_t)0x03000000)        /*!< ADC resolution */
#define ADC_CTL0_RWDEN                        ((uint32_t)0x00800000)        /*!< Regular channel analog watchdog enable */
#define ADC_CTL0_IWDEN                        ((uint32_t)0x00400000)        /*!< Inserted channel analog watchdog enable */
#define ADC_CTL0_DISNUM                       ((uint32_t)0x0000E000)        /*!< Number of conversions in discontinious mode */
#define ADC_CTL0_DISIC                        ((uint32_t)0x00001000)        /*!< Discontinious mode on inserted channels */
#define ADC_CTL0_DISRC                        ((uint32_t)0x00000800)        /*!< Discontinious mode on regular channels */
#define ADC_CTL0_ICA                          ((uint32_t)0x00000400)        /*!< Inserted channel group convert automatically */
#define ADC_CTL0_WDSC                         ((uint32_t)0x00000200)        /*!< When in scan mode, analog watchdog is effective on a single channel */
#define ADC_CTL0_SM                           ((uint32_t)0x00000100)        /*!< Scan mode */
#define ADC_CTL0_EOICIE                       ((uint32_t)0x00000080)        /*!< Interrupt enable for EOIC */
#define ADC_CTL0_WDEIE                        ((uint32_t)0x00000040)        /*!< Interrupt enable for WDE */
#define ADC_CTL0_EOCIE                        ((uint32_t)0x00000020)        /*!< Interrupt enable for EOC */
#define ADC_CTL0_WDCHSEL                      ((uint32_t)0x0000001F)        /*!< Analog watchdog channel select */

/********************  Bits definition for ADC_CTL1 register  *******************/
#define ADC_CTL1_TSVREN                       ((uint32_t)0x00800000)        /*!< Channel 16 and 17 enable of ADC */
#define ADC_CTL1_SWRCST                       ((uint32_t)0x00400000)        /*!< Start on regular channel */
#define ADC_CTL1_SWICST                       ((uint32_t)0x00200000)        /*!< Start on inserted channel */
#define ADC_CTL1_ETERC                        ((uint32_t)0x00100000)        /*!< External trigger enable for regular channel */
#define ADC_CTL1_ETSRC                        ((uint32_t)0x000E0000)        /*!< External trigger select for regular channel */
#define ADC_CTL1_ETEIC                        ((uint32_t)0x00008000)        /*!< External trigger enable for inserted channel */
#define ADC_CTL1_ETSIC                        ((uint32_t)0x00007000)        /*!< External trigger select for inserted channel */
#define ADC_CTL1_DAL                          ((uint32_t)0x00000800)        /*!< Data alignment */
#define ADC_CTL1_DMA                          ((uint32_t)0x00000100)        /*!< DMA request enable */
#define ADC_CTL1_RSTCLB                       ((uint32_t)0x00000008)        /*!< Reset calibration */
#define ADC_CTL1_CLB                          ((uint32_t)0x00000004)        /*!< ADC calibration */
#define ADC_CTL1_CTN                          ((uint32_t)0x00000002)        /*!< CONTINIOUS mode */
#define ADC_CTL1_ADCON                        ((uint32_t)0x00000001)        /*!< ADC ON */

/*******************  Bits definition for ADC_SAMPT0 register  *****************/
#define  ADC_SAMPT0_SPT17                     ((uint32_t)0x00E00000)       /*!< Channel sampling time */
#define  ADC_SAMPT0_SPT16                     ((uint32_t)0x001C0000)       /*!< Channel sampling time */

/*******************  Bits definition for ADC_SAMPT1 register  *****************/
#define  ADC_SAMPT1_SPT9                      ((uint32_t)0x38000000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT8                      ((uint32_t)0x07000000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT7                      ((uint32_t)0x00E00000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT6                      ((uint32_t)0x001C0000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT5                      ((uint32_t)0x00038000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT4                      ((uint32_t)0x00007000)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT3                      ((uint32_t)0x00000E00)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT2                      ((uint32_t)0x000001C0)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT1                      ((uint32_t)0x00000038)       /*!< Channel sampling time */
#define  ADC_SAMPT1_SPT0                      ((uint32_t)0x00000007)       /*!< Channel sampling time */

/*******************  Bits definition for ADC_IOFF register  *****************/
#define  ADC_IOFF_IOFF                        ((uint32_t)0x00000FFF)       /*!< Data offset for inserted channel */

/*******************  Bits definition for ADC_WDHT register  *****************/
#define  ADC_WDHT_WDHT                        ((uint32_t)0x00000FFF)       /*!< Analog watchdog high threshold */

/*******************  Bits definition for ADC_WDLT register  *****************/
#define  ADC_WDLT_WDLT                        ((uint32_t)0x00000FFF)       /*!< Analog watchdog low threshold */

/*******************  Bits definition for ADC_RSQ0 register  *****************/
#define  ADC_RSQ0_RL                          ((uint32_t)0x00F00000)       /*!< Regular channel group length */
#define  ADC_RSQ0_RSQ15                       ((uint32_t)0x000F8000)       /*!< The channel number */
#define  ADC_RSQ0_RSQ14                       ((uint32_t)0x00007C00)       /*!< The channel number */
#define  ADC_RSQ0_RSQ13                       ((uint32_t)0x000003E0)       /*!< The channel number */
#define  ADC_RSQ0_RSQ12                       ((uint32_t)0x0000001F)       /*!< The channel number */

/*******************  Bits definition for ADC_RSQ1 register  *****************/
#define  ADC_RSQ1_RSQ11                       ((uint32_t)0x3E000000)       /*!< The channel number */
#define  ADC_RSQ1_RSQ10                       ((uint32_t)0x01F00000)       /*!< The channel number */
#define  ADC_RSQ1_RSQ9                        ((uint32_t)0x000F8000)       /*!< The channel number */
#define  ADC_RSQ1_RSQ8                        ((uint32_t)0x00007C00)       /*!< The channel number */
#define  ADC_RSQ1_RSQ7                        ((uint32_t)0x000003E0)       /*!< The channel number */
#define  ADC_RSQ1_RSQ6                        ((uint32_t)0x0000001F)       /*!< The channel number */

/*******************  Bits definition for ADC_RSQ2 register  *****************/
#define  ADC_RSQ2_RSQ5                        ((uint32_t)0x3E000000)       /*!< The channel number */
#define  ADC_RSQ2_RSQ4                        ((uint32_t)0x01F00000)       /*!< The channel number */
#define  ADC_RSQ2_RSQ3                        ((uint32_t)0x000F8000)       /*!< The channel number */
#define  ADC_RSQ2_RSQ2                        ((uint32_t)0x00007C00)       /*!< The channel number */
#define  ADC_RSQ2_RSQ1                        ((uint32_t)0x000003E0)       /*!< The channel number */
#define  ADC_RSQ2_RSQ0                        ((uint32_t)0x0000001F)       /*!< The channel number */

/*******************  Bits definition for ADC_ISQ register  *****************/
#define  ADC_ISQ_IL                           ((uint32_t)0x00300000)       /*!< Inserted channel group length */
#define  ADC_ISQ_ISQ3                         ((uint32_t)0x000F8000)       /*!< The channel number */
#define  ADC_ISQ_ISQ2                         ((uint32_t)0x00007C00)       /*!< The channel number */
#define  ADC_ISQ_ISQ1                         ((uint32_t)0x000003E0)       /*!< The channel number */
#define  ADC_ISQ_ISQ0                         ((uint32_t)0x0000001F)       /*!< The channel number */

/*******************  Bits definition for ADC_IDATA register  *****************/
#define  ADC_IDATA_IDATA                      ((uint32_t)0x0000FFFF)       /*!< Inserted number n conversion data */

/*******************  Bits definition for ADC_RDATA register  *****************/
#define  ADC_RDATA_RDATA                      ((uint32_t)0x0000FFFF)       /*!< Regular number n conversion data */

/*******************  Bits definition for ADC_OVSAMPCTL register  *****************/
#define  ADC_OVSAMPCTL_TOVS                    ((uint32_t)0x00000200)       /*!< Triggered Oversampling */
#define  ADC_OVSAMPCTL_OVSS                    ((uint32_t)0x000001E0)       /*!< Oversampling shift */
#define  ADC_OVSAMPCTL_OVSR                    ((uint32_t)0x0000001C)       /*!< Oversampling ratio */
#define  ADC_OVSAMPCTL_OVSEN                   ((uint32_t)0x00000001)       /*!< Oversampling enable */
...
#define I2C_CTL0_SRESET            ((uint32_t)0x00008000)        /*!< Software reset I2C */
#define I2C_CTL0_SALT              ((uint32_t)0x00002000)        /*!< SMBus Alert */
#define I2C_CTL0_PECTRANS          ((uint32_t)0x00001000)        /*!< PEC Transfer */
#define I2C_CTL0_POAP              ((uint32_t)0x00000800)        /*!< Position of ACK and PEC when receiving */
#define I2C_CTL0_ACKEN             ((uint32_t)0x00000400)        /*!< Whether or not to send an ACK */
#define I2C_CTL0_STOP              ((uint32_t)0x00000200)        /*!< Generate a STOP condition on I2C bus */
#define I2C_CTL0_START             ((uint32_t)0x00000100)        /*!< Generate a START condition on I2C bus */
#define I2C_CTL0_SS                ((uint32_t)0x00000080)        /*!< Whether to stretch SCL low when data is not ready in slave mode */
#define I2C_CTL0_GCEN              ((uint32_t)0x00000040)        /*!< Whether or not to responce to a General Call */
#define I2C_CTL0_PECEN             ((uint32_t)0x00000020)        /*!< PEC Calculation Switch */
#define I2C_CTL0_ARPEN             ((uint32_t)0x00000010)        /*!< ARP protocol in SMBus switch */
#define I2C_CTL0_SMBSEL            ((uint32_t)0x00000008)        /*!< SMBus Type Selection */
#define I2C_CTL0_SMBEN             ((uint32_t)0x00000002)        /*!< SMBus/I2C mode switch */
#define I2C_CTL0_I2CEN             ((uint32_t)0x00000001)        /*!< I2C peripheral enable */

/*******************  Bit definition for I2C_CTL1 register  *******************/
#define I2C_CTL1_DMALST            ((uint32_t)0x00001000)        /*!< Flag indicating DMA last transfer */
#define I2C_CTL1_DMAON             ((uint32_t)0x00000800)        /*!< DMA mode switch */
#define I2C_CTL1_BUFIE             ((uint32_t)0x00000400)        /*!< Buffer interrupt enable */
#define I2C_CTL1_EVIE              ((uint32_t)0x00000200)        /*!< Event interrupt enable */
#define I2C_CTL1_ERRIE             ((uint32_t)0x00000100)        /*!< Error interrupt enable */
#define I2C_CTL1_I2CCLK            ((uint32_t)0x0000007F)        /*!< I2C Peripheral clock frequency */

/*******************  Bit definition for I2C_SADDR0 register  *******************/
#define I2C_SADDR0_ADDFORMAT        ((uint32_t)0x00008000)        /*!< Address mode for the I2C slave */
#define I2C_SADDR0_ADDRESS2         ((uint32_t)0x00000300)        /*!< Highest two bits of a 10-bit address */
#define I2C_SADDR0_ADDRESS1         ((uint32_t)0x000000FE)        /*!< 7-bit address or bits 7:1 of a 10-bit address */
#define I2C_SADDR0_ADDRESS0         ((uint32_t)0x00000001)        /*!< Bit 0 of a 10-bit address */

/*******************  Bit definition for I2C_SADDR1 register  *******************/
#define I2C_SADDR1_ADDRESS2         ((uint32_t)0x000000FE)        /*!< Second I2C address for the slave in Dual-Address mode */
#define I2C_SADDR1_DUADEN           ((uint32_t)0x00000001)        /*!< Dual-Address mode switch */

/*******************  Bit definition for I2C_DATA register  *******************/
#define I2C_DATA_DATA               ((uint32_t)0x0000000F)        /*!< Transmission or reception data buffer */

/*******************  Bit definition for I2C_STAT0 register  *******************/
#define I2C_STAT0_SMBALT             ((uint32_t)0x00008000)        /*!< SMBus Alert status */
#define I2C_STAT0_SMBTO              ((uint32_t)0x00004000)        /*!< Timeout signal in SMBus mode */
#define I2C_STAT0_PECERR             ((uint32_t)0x00001000)        /*!< PEC error when receiving data */
#define I2C_STAT0_OUERR              ((uint32_t)0x00000800)        /*!< Over-run or under-run situation occurs in slave mode */
#define I2C_STAT0_AERR               ((uint32_t)0x00000400)        /*!< Acknowledge Error */
#define I2C_STAT0_LOSTARB            ((uint32_t)0x00000200)        /*!< Arbitration Lost in master mode */
#define I2C_STAT0_BERR               ((uint32_t)0x00000100)        /*!< A bus error occurs indication an unexpected START or STOP condition */
#define I2C_STAT0_TBE                ((uint32_t)0x00000080)        /*!< I2C_DATA is Empty during transmitting */
#define I2C_STAT0_RBNE               ((uint32_t)0x00000040)        /*!< I2C_DATA is not Empty during receiving */
#define I2C_STAT0_STPDET             ((uint32_t)0x00000010)        /*!< STOP condition detected in slave mode */
#define I2C_STAT0_ADD10SEND          ((uint32_t)0x00000008)        /*!< Header of 10-bit address is sent in master mode */
#define I2C_STAT0_BTC                ((uint32_t)0x00000004)        /*!< Byte transmission completed */
#define I2C_STAT0_ADDSEND            ((uint32_t)0x00000002)        /*!< Address is sent in master mode */
#define I2C_STAT0_SBSEND             ((uint32_t)0x00000001)        /*!< START condition sent out in master mode */

/*******************  Bit definition for I2C_STAT1 register  *******************/
#define I2C_STAT1_PECV               ((uint32_t)0x00000F00)        /*!< Packet Error Checking Value */
#define I2C_STAT1_DUMODF             ((uint32_t)0x00000080)        /*!< Dual Flag in slave mode indicating which address is matched */
#define I2C_STAT1_HSTSMB             ((uint32_t)0x00000040)        /*!< SMBus Host Header detected in slave mode */
#define I2C_STAT1_DEFSMB             ((uint32_t)0x00000020)        /*!< Default address of SMBus Device */
#define I2C_STAT1_RXGC               ((uint32_t)0x00000010)        /*!< General call address (00h) received */
#define I2C_STAT1_TR                 ((uint32_t)0x00000004)        /*!< Whether the I2C is a transmitter or a receiver */
#define I2C_STAT1_I2CBSY             ((uint32_t)0x00000002)        /*!< Busy flag */
#define I2C_STAT1_MASTER             ((uint32_t)0x00000001)        /*!< Master mode */

/*******************  Bit definition for I2C_CKCFG register  *******************/
#define I2C_CKCFG_FAST               ((uint32_t)0x00008000)        /*!< I2C speed selection in master mode */
#define I2C_CKCFG_DTCY               ((uint32_t)0x00004000)        /*!< Duty cycle in fast mode */
#define I2C_CKCFG_CLKC               ((uint32_t)0x00000FFF)        /*!< I2C Clock control in master mode */

/*******************  Bit definition for I2C_RT register  *******************/
#define I2C_RT_RT                    ((uint32_t)0x0000007F)        /*!< Maximum rise time in master mode */

/*******************  Bit definition for I2C_SAMCS register  *******************/
#define I2C_SAMCS_RFR                ((uint32_t)0x00008000)        /*!< Rxframe rise flag */
#define I2C_SAMCS_RFF                ((uint32_t)0x00004000)        /*!< Rxframe fall flag */
#define I2C_SAMCS_TFR                ((uint32_t)0x00002000)        /*!< Txframe rise flag */
#define I2C_SAMCS_TFF                ((uint32_t)0x00001000)        /*!< Txframe fall flag */
#define I2C_SAMCS_RXF                ((uint32_t)0x00000200)        /*!< Level of rxframe signal */
#define I2C_SAMCS_TXF                ((uint32_t)0x00000100)        /*!< Level of txframe signal */
#define I2C_SAMCS_RFRIE              ((uint32_t)0x00000080)        /*!< Rxframe rise interrupt enable */
#define I2C_SAMCS_RFFIE              ((uint32_t)0x00000040)        /*!< Rxframe fall interrupt enable */
#define I2C_SAMCS_TFRIE              ((uint32_t)0x00000020)        /*!< Txframe rise interrupt enable */
#define I2C_SAMCS_TFFIE              ((uint32_t)0x00000010)        /*!< Txframe fall interrupt enable */
#define I2C_SAMCS_STOEN              ((uint32_t)0x00000002)        /*!< SAM_V interface timeout detect enable */
#define I2C_SAMCS_SAMEN              ((uint32_t)0x00000001)        /*!< SAM_V interface enable */

/*******************  Bit definition for I2C_FMPCFG register  *******************/
#define I2C_FMPCFG_FMPEN             ((uint32_t)0x00000001)        /*!< Fast mode plus enable */
