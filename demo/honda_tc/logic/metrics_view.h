...
/*
    ...
    итого у нас есть макрос который содержит
        имя енума
        имя для текста на экране
        юнит
    ...
    каждый тип метрик реализует свое количество. и должен реализовывать свой енум, а также свою функцию вычисления
*/
