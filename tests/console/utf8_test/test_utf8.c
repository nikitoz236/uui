...
struct {
    ...
    { .s = (utf16_t []){ 0x041F, 0x0440, 0x0438, 0x0432, 0x0435, 0x0442, 0 }, .sl = 0, .dl = 16, .ref = "\xD0\x9F\xD1\x80\xD0\xB8\xD0\xB2\xD0\xB5\xD1\x82", .ref_len = 12 },
    // 5 - Русское "ёж" + latin "abc"
    { .s = (utf16_t []){ 0x0451, 0x0436, 'a', 'b', 'c', 0 }, .sl = 0, .dl = 16, .ref = "\xD1\x91\xD0\xB6""abc", .ref_len = 7 },
    // 6 - Суррогатная пара (high surrogate)
    { .s = (utf16_t []){ 0xD834, 0xDD1E, 0 }, .sl = 0, .dl = 8, .ref = "@@", .ref_len = 2 },
    // 7 - Одиночный суррогат (low surrogate)
    { .s = (utf16_t []){ 0xDD1E, 0 }, .sl = 0, .dl = 8, .ref = "@", .ref_len = 1 },
};
